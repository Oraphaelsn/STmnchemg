  ...
  const contactInfo = [
    {
      ...
      description: "Atendimento de urgência e informações",
            ...
            <div className="space-y-6">
              {contactInfo.map((info, index) => (
                <div key={index} className="flex items-start">
                  <div className={`${info.bgColor} w-12 h-12 rounded-full flex items-center justify-center mr-4 flex-shrink-0 text-white`}>
                    {info.icon}
                  </div>
                  <div>
                    <h4 className="font-semibold mb-1">{info.title}</h4>
                    <p className="text-blue-100 mb-2">{info.content}</p>
