...
export default function MiniContactForm() {
    ...
    return (
      <div className="fixed top-20 right-4 z-50 animate-bounce">
        <button
          ...
          className="bg-gradient-to-r from-[var(--primary)] to-[var(--primary-light)] text-white px-6 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center hover:from-[var(--primary-dark)] hover:to-[var(--primary)] transform hover:-translate-y-0.5"
        >
  ...
  return (
    <div className="fixed top-20 right-4 z-50 bg-white rounded-xl shadow-2xl p-6 w-80 border-2 border-[var(--primary)]">
      ...
      <div className="bg-[var(--soft-green)] p-3 rounded-lg mb-4">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <Button 
            type="submit" 
            className="w-full bg-gradient-to-r from-[var(--primary)] to-[var(--primary-light)] hover:from-[var(--primary-dark)] hover:to-[var(--primary)] text-white transition-all duration-300"
          ...
          <div className="text-center">
            <a 
              ...
              className="text-[var(--primary-light)] hover:underline text-sm flex items-center justify-center hover:text-[var(--primary)]"
            >
