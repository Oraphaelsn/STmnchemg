        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
              Sua saúde mental merece o{" "}
              <span className="text-[hsl(207,90%,54%)]">melhor cuidado</span>
            </h1>
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Hospital de saúde mental em Ibiúna/SP com certificação ISO 9001:2015. 
              Abordagem humanista, equipe multidisciplinar e ambiente acolhedor em meio à natureza desde 2002.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a 
                href="tel:+551140028922" 
                className="bg-[hsl(20,90%,48%)] hover:bg-[hsl(20,90%,43%)] text-white px-8 py-4 rounded-lg font-semibold transition-colors flex items-center justify-center"
              >
                <svg className="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/>
                </svg>
                Ligue Agora: (11) 4002-8922
              </a>
              <a 
                href="https://wa.me/5511999999999" 
                className="bg-green-500 hover:bg-green-600 text-white px-8 py-4 rounded-lg font-semibold transition-colors flex items-center justify-center"
              >
                <svg className="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 24 24">
